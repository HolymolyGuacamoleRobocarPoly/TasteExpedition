...
<!--Theme custom css -->
<link rel="stylesheet" href="/tastyServer/assets/css/style.css">
...
<body>
    ...
    <form action="/tastyServer/insert.rv" method="post" onsubmit="return false">
        <div class="review_container">
        	<div class="review_writearea">
                ...
                <div class="review_remain">
	            	...
	            	<input type="text" placeholder="#해시태그" value="" data-role="tagsinput" id="tags" class="form-control"> <br> <br>    
